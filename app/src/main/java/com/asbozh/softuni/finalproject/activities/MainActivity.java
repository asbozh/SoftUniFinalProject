...
import com.asbozh.softuni.finalproject.fragments.AllRecordsFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    AllRecordsFragment allRecsFrag;
    ...
    private void navigate(int mNavItemId) {
        ...
        switch(mNavItemId) {
            ...
            case R.id.nav_all_records:
                allRecsFrag = new AllRecordsFragment();
                transaction = manager.beginTransaction();
                transaction.replace(R.id.fragment_content, allRecsFrag, "AllFuelRecordsFragment");
                transaction.addToBackStack(null);
                transaction.commit();
                mToolbar.setTitle(getString(R.string.nav_all_records));
                break;
